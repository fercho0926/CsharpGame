    ...
    <section className="sql-course">
      ...
      <div className="sql-layout">
        <aside className="sql-modules" aria-label="Módulos del curso SQL">
          <div className="sql-modules-heading"><span>CURSO · FUNDAMENTOS</span><b>{selectedModule === "rdbms" ? "1" : selectedModule === "sql-server" ? "2" : "3"} de 5</b></div>
          {modules.map((module) => (
        ...
        </article> : selectedModule === "sql-server" ? <SqlToolsLesson /> : <TsqlDmlLesson />}
      </div>
    </section>
  );
}
