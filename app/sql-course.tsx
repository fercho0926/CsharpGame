...
const modules = [
  ...
  { id: "relationships", number: "05", title: "Relaciones e integridad de datos", duration: "Próximamente", active: false },
];
    ...
    <section className="sql-course">
      ...
      <div className="sql-layout">
        <aside className="sql-modules" aria-label="Módulos del curso SQL">
          <div className="sql-modules-heading"><span>CURSO · FUNDAMENTOS</span><b>{selectedModule === "rdbms" ? "1" : selectedModule === "sql-server" ? "2" : selectedModule === "tsql-dml" ? "3" : "4"} de 5</b></div>
          {modules.map((module) => (
        ...
        </article> : selectedModule === "sql-server" ? <SqlToolsLesson /> : selectedModule === "tsql-dml" ? <TsqlDmlLesson /> : <SchemasDdlLesson />}
      </div>
    </section>
  );
}
